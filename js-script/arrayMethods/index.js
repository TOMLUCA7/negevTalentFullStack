...
// const emailAndCompany = Users.map((info) => {
//   return { email: info.email, company: info.company.name };
// });

// console.log(emailAndCompany);

// 2
// const zip = Users.filter((zipCodefive) => {
//   return zipCodefive.address.zipcode[0] === "5"
// });
...
// 4
// const nameWithLetterC = Users.filter((letter) => {
//   return letter.name[0] === "C";
// }).map((onlyName) => {
//   return onlyName.name;
// });

// console.log(nameWithLetterC);

// 5
// const city = Users.every((cityName) => {
//   return cityName.address.city === "South Christy";
// });

// console.log(city);

// 6
// const suiteHome = Users.find((p) => p.address.suite === "Apt. 950").company
//   .name;
// console.log(suiteHome);
...
// let totalGrades = studentScores.reduce((counts, grade) => {
//   const letter = chackGrade(grade);
...
//   return count + itemCost + itemCost * taxRates[item.category];
// }, 0);
